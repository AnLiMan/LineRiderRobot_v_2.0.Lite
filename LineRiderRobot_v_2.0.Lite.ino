...
void ManualControl() {
  ...
  //Поворот вправо
    ...
    int RightMotorSpeed = idleSpeed * (Omega1 / Omega2); //Корректируем скорость правого двигателя на Omega1/Omega2
  ...
  //Поворот налево
    ...
    analogWrite(RightMotor, int(idleSpeed * RightMotorAdj));
    ElectronicDiff(SteeringAngle); //Расчитаем скорости
    int LeftMotorSpeed = idleSpeed *  (Omega1 / Omega2); //Корректируем скорость левого двигателя на Omega2/Omega1 (0.8 для гипертрофированного поворота)
